        ...
        j.setAttribute("role", "treeitem"),
            ...
            (a.jstree.core.prototype = {
                ...
                get_next_dom: function (b, c) {
                    var d;
                    if (
                        ((b = this.get_node(b, !0)), b[0] === this.element[0])
                    ) {
                ...
                get_prev_dom: function (b, c) {
                    ...
                    return (
                        ...
                        d &&
                        d.className &&
                        -1 !== d.className.indexOf("jstree-node")
                            ? a(d)
                            : !1
                    );
                },
                ...
                is_loading: function (a) {
                    return (
                        (a = this.get_node(a)), a && a.state && a.state.loading
                    );
                },
                is_open: function (a) {
                ...
                _load_nodes: function (a, b, c) {
                    ...
                    for (g = 0, h = a.length; h > g; g++)
                        !f[a[g]] ||
                            ((f[a[g]].state.loaded || f[a[g]].state.failed) &&
                                c) ||
                            (this.is_loading(a[g]) || this.load_node(a[g], e),
                            (d = !1));
                    if (d) {
                        for (g = 0, h = a.length; h > g; g++)
                ...
                load_all: function (b, c) {
                    ...
                    var d = [],
                        ...
                        h;
                    for (
                        b.state && !b.state.loaded && d.push(b.id),
                            g = 0,
                            h = f.length;
                        h > g;
                        g++
                    ...
                    return d
                        ? a.isFunction(d)
                            ...
                            ? d.url
                                ? ((d = a.extend(!0, {}, d)),
                                  a.isFunction(d.url) &&
                                      (d.url = d.url.call(this, b)),
                                  a.isFunction(d.data) &&
                                      (d.data = d.data.call(this, b)),
                                  a
                                      .ajax(d)
                                      .done(
                ...
                _append_html_data: function (b, c, d) {
                    ...
                    for (
                            ...
                            a.proxy(function (b, c) {
                                (l = this._parse_model_from_html(
                                    ...
                                    l &&
                                        (g.push(l),
                                        h.push(l),
                                        i[l].children_d.length &&
                                            (h = h.concat(i[l].children_d)));
                            }, this)
                        ),
                            j.children = g,
                            j.children_d = h,
                        ...
                        i[j.parents[m]].children_d =
                            i[j.parents[m]].children_d.concat(h);
                        ...
                        var f = null,
                            ...
                            h = function (a, b) {
                                ...
                                if (
                                    ...
                                    for (
                                        o = 0, p = l.parents.length;
                                        p > o;
                                        o++
                                    )
                                        k[l.parents[o]].children_d =
                                            k[l.parents[o]].children_d.concat(
                                                f
                                            );
                                    q = {
                                        cnt: j,
                            ...
                            i = function (b, c) {
                                if (null !== this.element) {
                                    if (
                                        ...
                                        if (
                                            h.length !== i.length ||
                                            a.vakata.array_unique(h.concat(i))
                                                .length !== h.length
                                        ) {
                                            for (
                                                e = 0, f = h.length;
                ...
                _parse_model_from_html: function (c, d, e) {
                    ...
                    if (
                        ...
                        (k = k.html()),
                        (k = a("<div />").html(k)),
                        (i.text = this.settings.core.force_text
                            ? k.text()
                            : k.html()),
                        (k = c.data()),
                ...
                _parse_model_from_flat_json: function (a, c, d) {
                    ...
                    if (a && "object" == typeof a.state)
                        for (h in a.state)
                            a.state.hasOwnProperty(h) &&
                                (l.state[h] = a.state[h]);
                    if (a && "object" == typeof a.li_attr)
                        for (h in a.li_attr)
                            a.li_attr.hasOwnProperty(h) &&
                                (l.li_attr[h] = a.li_attr[h]);
                    if (
                        (l.li_attr.id || (l.li_attr.id = e),
                        a && "object" == typeof a.a_attr)
                    )
                        for (h in a.a_attr)
                            a.a_attr.hasOwnProperty(h) &&
                                (l.a_attr[h] = a.a_attr[h]);
                    for (
                        a &&
                            a.children &&
                            a.children === !0 &&
                        ...
                        (j = this._parse_model_from_flat_json(
                            f[l.children[h]],
                            l.id,
                            d
                        )),
                            ...
                            l.children_d.push(j),
                            k.children_d.length &&
                                (l.children_d = l.children_d.concat(
                                    k.children_d
                                ));
                    return (
                        delete a.data,
                ...
                _parse_model_from_json: function (a, c, d) {
                    ...
                    l = {
                        ...
                        text: "string" == typeof a ? a : "",
                        icon:
                            "object" == typeof a && a.icon !== b ? a.icon : !0,
                        parent: c,
                        parents: d,
                        children: [],
                        children_d: [],
                ...
                draw_children: function (b) {
                    ...
                    if (
                        ...
                        for (
                            ...
                            f.appendChild(
                                this.redraw_node(c.children[d], !0, !0)
                            );
                        b.appendChild(f);
                    }
                },
                redraw_node: function (b, c, d, e) {
                    ...
                    if (
                        ...
                        q[f.parent] &&
                        !f.state.hidden &&
                        ((l = a.inArray(f.id, q[f.parent].children)),
                        (x = f.id),
                        -1 !== l)
                    )
                    ...
                    if (
                        (o.length &&
                            (b.childNodes[1].className = "jstree-anchor " + o),
                            ...
                            (f.icon === !1
                                ...
                                : ((b.childNodes[1].childNodes[0].style.backgroundImage =
                                  ...
                                  (b.childNodes[1].childNodes[0].style.backgroundPosition =
                                      "center center"),
                                  (b.childNodes[1].childNodes[0].style.backgroundSize =
                                      "auto"),
                                  (b.childNodes[1].childNodes[0].className +=
                                      " jstree-themeicon-custom"))),
                        this.settings.core.force_text
                            ? b.childNodes[1].appendChild(
                                  p.createTextNode(f.text)
                              )
                        ...
                        for (
                            ...
                            n.appendChild(
                                this.redraw_node(f.children[l], c, !0)
                            );
                        b.appendChild(n);
                    }
                    if ((k && b.appendChild(k), !d)) {
                        for (
                            ...
                            if (
                                ...
                                -1 !==
                                    g.childNodes[l].className.indexOf(
                                        "jstree-children"
                                    )
                            ) {
                                t = g.childNodes[l];
                ...
                is_disabled: function (a) {
                    return (
                        (a = this.get_node(a)), a && a.state && a.state.disabled
                    );
                },
                ...
                get_state: function () {
                    ...
                    for (c in this._model.data)
                        this._model.data.hasOwnProperty(c) &&
                            c !== a.jstree.root &&
                            (this._model.data[c].state.opened &&
                                b.core.open.push(c),
                            this._model.data[c].state.selected &&
                                b.core.selected.push(c));
                    return b;
                },
                        ...
                        if (c.core) {
                            ...
                            for (i in c)
                                c.hasOwnProperty(i) &&
                                    "core" !== i &&
                                    -1 ===
                                        a.inArray(i, this.settings.plugins) &&
                                    delete c[i];
                ...
                set_id: function (b, c) {
                    ...
                    for (
                        c = c.toString(),
                            f[b.parent].children[
                                a.inArray(b.id, f[b.parent].children)
                            ] = c,
                            d = 0,
                            e = b.parents.length;
                        e > d;
                ...
                get_json: function (b, c, d) {
                    ...
                    var e = {
                            ...
                            state: {},
                            data:
                                c && c.no_data ? !1 : a.extend(!0, {}, b.data),
                        },
                        f,
                        g;
                    if (
                ...
                delete_node: function (b) {
                    ...
                    for (
                        -1 !== f &&
                            (e.children = a.vakata.array_remove(e.children, f)),
                ...
                check: function (b, c, d, e, f) {
                    ...
                    var g = b.match(/^move_node|copy_node|create_node$/i)
                            ? d
                            : c,
                    ...
                    if (c.parent === n.id) {
                        ...
                        for (
                            ...
                            (this._model.data[c.children_d[s]].parents =
                                this._model.data[c.children_d[s]].parents.slice(
                                    0,
                                    -1 * w
                                )),
            ...
            (a.vakata.array_remove = function (a, b, c) {
                ...
                return (
                    (a.length = 0 > b ? a.length + b : b), a.push.apply(a, d), a
                );
            }),
        ...
        (m.className = "jstree-icon jstree-checkbox"),
            ...
            (a.jstree.plugins.checkbox = function (c, d) {
                (this.bind = function () {
                            ...
                            this.element
                                .on(
                                    ...
                                    a.proxy(function (b, c) {
                                        ...
                                        if (-1 !== n.indexOf("up")) {
                                            for (
                                                i = 0, j = e.children_d.length;
                                                j > i;
                                                i++
                                            )
                                                d[e.children_d[i]].children
                                                    .length ||
                                                    g.push(
                                                        d[e.children_d[i]]
                                                            .parent
                                ...
                                .on(
                                    ...
                                    a.proxy(function (b, c) {
                                        ...
                                        (this._data[
                                            j ? "core" : "checkbox"
                                        ].selected = a.vakata.array_unique(h)),
                                            -1 !== i.indexOf("down") &&
                                                e.length &&
                                                e
                                                    .find(".jstree-anchor")
                        ...
                        if ((b = d.redraw_node.apply(this, arguments))) {
                            ...
                            for (g = 0, h = b.childNodes.length; h > g; g++)
                                if (
                                    ...
                                    -1 !==
                                        b.childNodes[g].className.indexOf(
                                            "jstree-anchor"
                                        )
                                ) {
                                    i = b.childNodes[g];
                    ...
                    (this.is_undetermined = function (b) {
                        ...
                        if (
                            !b.state.loaded &&
                            b.original.state.undetermined === !0
                        )
                            return !0;
                        for (d = 0, e = b.children_d.length; e > d; d++)
                            if (
                                ...
                                (!h[b.children_d[d]].state.loaded &&
                                    h[b.children_d[d]].original.state
                                        .undetermined)
                            )
                                return !0;
                        return !1;
                    ...
                    (this.uncheck_all = function () {
                        ...
                        var a = this._data.checkbox.selected.concat([]),
                            ...
                            c;
                        for (
                            b = 0, c = this._data.checkbox.selected.length;
                            c > b;
                            b++
                        )
                    ...
                    (this.load_node = function (b, c) {
                        ...
                        if (
                            ...
                            for (e = 0, f = j.children_d.length; f > e; e++)
                                this._model.data[j.children_d[e]].state
                                    .checked &&
                                    ((i = !0),
                                    (this._data.checkbox.selected =
                                        a.vakata.array_remove_item(
                ...
                (this.bind = function () {
                    ...
                    this.element
                        ...
                        .on("touchmove.vakata.jstree", function (a) {
                            c &&
                                ...
                                (Math.abs(e - a.pageX) > 50 ||
                                    Math.abs(f - a.pageY) > 50) &&
                                clearTimeout(c);
                        })
                    ...
                    (this.show_contextmenu = function (c, d, e, f) {
                        ...
                        (g.show_at_node || d === b || e === b) &&
                            ...
                            a.isPlainObject(k) &&
                                this._show_contextmenu(c, d, e, k);
                    }),
                                ...
                                .on("mouseenter", "li", function (b) {
                                    b.stopImmediatePropagation(),
                                        a.contains(this, b.relatedTarget) ||
                                            ...
                                            a.vakata.context._show_submenu(
                                                this
                                            ));
                                })
                    ...
                    c.bind.call(this),
                        this.element.on(
                            ...
                            a.proxy(function (b) {
                                if (
                                    this.settings.dnd.large_drag_target &&
                                    a(b.target).closest(".jstree-node")[0] !==
                                        b.currentTarget
                                )
                                    return !0;
                                if (
            ...
            a(function () {
                ...
                a(i)
                    ...
                    .on("dnd_move.vakata.jstree", function (g, h) {
                        if (
                            ...
                            h &&
                                ...
                                h.data.jstree &&
                                (!h.event.target.id ||
                                    "jstree-marker" !== h.event.target.id))
                        ) {
                            d = h.event;
                            ...
                            if (i && i._data && i._data.dnd)
                                if (
                                    ...
                                    (h.event.target !== i.element[0] &&
                                        h.event.target !==
                                            i.get_container_ul()[0]) ||
                                        0 !==
                                            i.get_container_ul().children()
                                                .length)
                                ) {
                                    if (
                    ...
                    .on("dnd_stop.vakata.jstree", function (g, h) {
                        if (
                            (e && clearTimeout(e), h && h.data && h.data.jstree)
                        ) {
                            f.hide().detach();
                            var i,
                                j,
            ...
            (function (a) {
                a.vakata.html = {
                    ...
                    strip: function (b) {
                        return a.vakata.html.div
                            .empty()
                            .append(a.parseHTML(b))
                            .text();
                    },
                };
                var b = {
                ...
                a.vakata.dnd = {
                    ...
                    _trigger: function (b, c) {
                        ...
                        (d.event = c),
                            a(i).triggerHandler("dnd_" + b + ".vakata", d);
                    },
                    _get: function () {
                        return {
                            data: b.data,
                    ...
                    _clean: function () {
                        b.helper && b.helper.remove(),
                            b.scroll_i &&
                                (clearInterval(b.scroll_i), (b.scroll_i = !1)),
                            (b = {
                                element: !1,
                                target: !1,
                                is_down: !1,
                    ...
                    _scroll: function (c) {
                        if (!b.scroll_e || (!b.scroll_l && !b.scroll_t))
                            return (
                                b.scroll_i &&
                                    (clearInterval(b.scroll_i),
                                    (b.scroll_i = !1)),
                                !1
                            );
                        if (!b.scroll_i)
                            return (
                                (b.scroll_i = setInterval(
                                    a.vakata.dnd._scroll,
                                    100
                                )),
                                !1
                            );
                        ...
                        b.scroll_e.scrollTop(
                            ...
                            b.scroll_e.scrollLeft(
                                e +
                                    b.scroll_l *
                                        a.vakata.dnd.settings.scroll_speed
                            ),
                            (d !== b.scroll_e.scrollTop() ||
                                e !== b.scroll_e.scrollLeft()) &&
                    ...
                    start: function (c, d, e) {
                        "touchstart" === c.type &&
                            ...
                            ((c.pageX =
                                c.originalEvent.changedTouches[0].pageX),
                            (c.pageY = c.originalEvent.changedTouches[0].pageY),
                            (c.target = i.elementFromPoint(
                                c.originalEvent.changedTouches[0].pageX -
                                    window.pageXOffset,
                                c.originalEvent.changedTouches[0].pageY -
                                    window.pageYOffset
                            ))),
                        ...
                        try {
                            (c.currentTarget.unselectable = "on"),
                                ...
                                c.currentTarget.style &&
                                    (c.currentTarget.style.MozUserSelect =
                                        "none");
                        } catch (f) {}
                        return (
                            (b.init_x = c.pageX),
                        ...
                        if (
                            ...
                            return (
                                ...
                                b.helper &&
                                    ((m = parseInt(
                                        c.pageY +
                                            a.vakata.dnd.settings.helper_top,
                                        10
                                    )),
                                    (n = parseInt(
                                        c.pageX +
                                            a.vakata.dnd.settings.helper_left,
                                        10
                                    )),
                                    f && m + 25 > f && (m = f - 50),
                                    h &&
                ...
                (this.init = function (a, b) {
                    ...
                    (this._load_nodes = function (b, d, e) {
                        ...
                        return e && !a.isEmptyObject(this._data.massload)
                            ...
                            ? ((f = a.extend(!0, {}, f)),
                              a.isFunction(f.url) &&
                                  (f.url = f.url.call(this, b)),
                              a.isFunction(f.data) &&
                                  (f.data = f.data.call(this, b)),
                              a
                                  .ajax(f)
                                  .done(
                ...
                (this.bind = function () {
                    ...
                    (this.search = function (c, d, e, f, g, h) {
                        ...
                        if (
                            ...
                            a.each(
                                k[f ? f : a.jstree.root].children_d,
                                function (a, b) {
                                    var d = k[b];
                                    d.text &&
                                        (!i.search_leaves_only ||
                                            (d.state.loaded &&
                                                0 === d.children.length)) &&
                                        ((i.search_callback &&
                                            i.search_callback.call(
                                                this,
                                                c,
                                                d
                                            )) ||
                                            (!i.search_callback &&
                                                l.search(d.text).isMatch)) &&
                    ...
                    (this.sort = function (b, c) {
                        ...
                        if (
                            ...
                            b &&
                                ...
                                b.children.length &&
                                (b.children.sort(
                                    a.proxy(this.settings.sort, this)
                                ),
                                c))
                        )
                            for (d = 0, e = b.children_d.length; e > d; d++)
                ...
                (this.bind = function () {
                    ...
                    (this.restore_state = function () {
                        ...
                        return b &&
                            b.ttl &&
                            b.sec &&
                            +new Date() - b.sec > b.ttl
                            ? !1
                            : (b && b.state && (b = b.state),
                              b &&
                                  a.isFunction(this.settings.state.filter) &&
                                  (b = this.settings.state.filter.call(
                                      this,
                                      b
                                  )),
                              b
                ...
                (this.init = function (c, e) {
                    ...
                    (this.refresh = function (b, c) {
                        d.refresh.call(this, b, c),
                            (this._model.data[a.jstree.root].type =
                                a.jstree.root);
                    }),
                    (this.bind = function () {
                        this.element.on(
                            ...
                            for (f = 0, g = j.length; g > f; f++)
                                (j[f].type =
                                    ...
                                    c &&
                                        ...
                                        j[f].li_attr &&
                                            j[f].li_attr.id &&
                                            delete j[f].li_attr.id,
                                        j[f].a_attr &&
                                            j[f].a_attr.id &&
                                            delete j[f].a_attr.id);
                        else
                            (j.type =
                                j.id && h[j.id] && h[j.id].type
                                    ? h[j.id].type
                                    : "default"),
