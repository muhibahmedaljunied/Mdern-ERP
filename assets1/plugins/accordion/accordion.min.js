        ...
        return (
            ...
            (this.create = function () {
                ...
                if (
                    ...
                    i.activeIndex > 1
                        ? n.openSection(c.eq(i.activeIndex - 1), 0)
                        : !1 !== i.activeIndex && n.openSection(c.eq(0), 0);
            }),
            (this.createSingleSection = function (c) {
                ...
                c.addClass("acc_section"),
                    ...
                    c.hasClass("acc_active") ||
                        c.children(".acc_content").hide();
            }),
            (this.openOnClick = function () {
                n.on("click", ".acc_head", function (c) {
                    c.stopImmediatePropagation();
                    var o = e(this).closest(".acc_section");
                    t.sectionIsOpen(o)
                        ? i.closeAble
                            ? n.closeSection(o)
                            : 1 === n.children().length && n.closeSection(o)
                        : i.closeOther
                        ? (n.closeOtherSections(o), n.openSection(o))
                        : n.openSection(o);
                });
            }),
            (this.openOnHash = function () {
                if (t.getHash()) {
                    var c = e("#" + t.getHash());
                    c.hasClass("acc_section") &&
                        (n.openSection(c),
                        i.closeOther && n.closeOtherSections(c),
                        e("html, body").animate(
