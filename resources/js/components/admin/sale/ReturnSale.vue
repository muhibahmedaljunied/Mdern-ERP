                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="custom-search">
                                            ...
                                            <input :id="'SaleReturn_account_tree'" type="text"
                                                class="custom-search-input">
                                            <input :id="'SaleReturn_account_tree_id'" type="hidden"
                                                class="custom-search-input">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="custom-search">
                                            ...
                                            <input style="background-color: beige;" :id="'SaleReturn_store_tree'"
                                                type="text" class="custom-search-input">
                                            <input :id="'SaleReturn_store_tree_id'" type="hidden">
                                            <input :id="'select_account_SaleReturn'" type="hidden"
                                                class="custom-search-input">
                                            <button class="custom-search-botton" type="button" data-toggle="modal"
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody v-if="detail && detail.length > 0">
                                                    <tr v-for="(sale_details, index) in detail" :key="index">
                                                        <input v-model="id = sale_details.sale_id" type="hidden"
                                ...
                                <vue-barcode :value="sale_details.product_code" tag="svg" width='2'
                                  height='70'></vue-barcode>
                                                        ...
                                                        <td>{{ sale_details.store }}
                                                            <input :id="'select_account_SaleReturn' + index"
                                                                type="hidden">
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="custom-search">
                                                                ...
                                                                <input style="background-color: beige;"
                                                                    :id="'SaleReturn_storem_tree' + index" type="text"
                                                                    class="custom-search-input">
                                                                <input :id="'SaleReturn_storem_tree_id' + index"
                                                                    type="hidden">
...
temx.name }}</span>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div
                                                                v-for="temx in sale_details.qty_after_convert['qty_remain']">
...
temx.name }}</span>
                    ...
                    {{ unit_price[index] }}
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                <input @input="calculate()" v-model="qty[index]"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" @input="calculate()" id="subtotal_general"
