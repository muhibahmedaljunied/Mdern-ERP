                        ...
                        <td>
                          ...
                          <div class="optionbox">
                            <select @change="changeRoute(index)" v-model="operationselected[index]" name="العمليات"
                              ...
                              <option class="btn btn-success" v-bind:value="['return_sale_recive', return_sales.id, 2]">
                            ...
                            تعديل الفاتوره
                              ...
                              <option class="btn btn-success" v-bind:value="['return_sale_daily', return_sales.id, 5]">
                                عرض القيد المحاسبي
                              </option>
