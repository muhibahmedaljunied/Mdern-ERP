        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card" id="printme" style="outline: auto; outline-color: red; border-radius: 10">
                  ...
                  <thead>
                    <tr>
                      ...
                      <td rowspan="4" style="text-align: center;line-height: 1px;"> <img
                          :src="`/assets/img/images3.jpg`" height="150px" alt="products image" /></td>
                      <td rowspan="4" style="text-align: center;line-height: 1px;">
              ...
              <div class="card-body">
                <table class="table table-bordered text-right" style="width: 100%; font-size:30px;text-align:center">
