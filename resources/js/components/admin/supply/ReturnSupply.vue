                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2" v-if="data.payment_status == 'pendding'">
                                        ...
                                        <input readonly style="background-color: beige;" name="date" type="text"
                                            value="أجل" class="form-control" />
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="custom-search">
                                            ...
                                            <input :id="'SupplyReturn_account_tree'" type="text" readonly
                                                class="custom-search-input">
                                            <input :id="'SupplyReturn_account_tree_id'" type="hidden" readonly
                                                class="custom-search-input">
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody v-if="detail && detail.length > 0">
                                                    <tr v-for="(supply_details, index) in detail" :key="index">
                                                        <input v-model="id = supply_details.supply_id" readonly
                                                            type="hidden" name="name" id="name" class="form-control" />
                                                        ...
                                                        <td>
                                                            ...
                                                            <div>
                                                                <input type="hidden" v-model="supply_details.text"
                                                                    id="desc" class="form-control" />

                                                                <span>{{ supply_details.text }}</span>
                                                                <span style="color: blue;" v-if="supply_details.kk"
                                                                    v-for="ss in supply_details.kk">
                                                        ...
                                                        <td>
                                                            ...
                                                            <div
                                                                v-for="temx in supply_details.qty_after_convert['qty']">
...
temx.name }}</span>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div
                                                                v-for="temx in supply_details.qty_after_convert['quantity']">
...
temx.name }}</span>
                                                        ...
                                                        <td>{{ supply_details.store }} <input
                                                                id="select_account_SupplyReturn" type="hidden"
                                                                v-model="supply_details.store_account"></td>

                                                        <td>

                                                            <div
                                                                v-for="temx in supply_details.qty_after_convert['qty_remain']">
...
temx.name }}</span>
                                                        ...
                                                        <td>
                                                            <input v-on:input="calculate()"
                                                                style="background-color: beige;" type="hidden"
                                                        ...
                                                        <td>
                                                            <input v-on:change="calculate()" v-model="total[index]"
