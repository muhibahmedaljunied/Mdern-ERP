                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="custom-search">
                                            ...
                                            <input style="background-color: beige;font-size: 15px;"
                                                :id="'Supply_product_tree'" type="text" readonly
                                                class="custom-search-input">
                                            <input :id="'Supply_product_tree_id'" type="hidden" readonly
                                                class="custom-search-input">
                                            <input :id="'select_account_Supply'" type="hidden" readonly
                                                class="custom-search-input">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="custom-search">
                                            ...
                                            <input :id="'Supply_account_tree'" type="text" readonly
                                                class="custom-search-input">
                                            <input :id="'Supply_account_tree_id'" type="hidden" readonly
                                                class="custom-search-input">
                              ...
                              <button class="custom-search-botton" type="button" data-toggle="modal"
                                ...
                                <input type="text" v-model="sto_pro.text" id="desc" class="form-control" />
                                                        ...
                                                        <div class="custom-search">
                                                            ...
                                                            <input style="background-color: beige;font-size: 15px;"
                                                                :id="'Supply_storem_tree' + index" type="text" readonly
                                                                class="custom-search-input">
                                                            <input :id="'Supply_storem_tree_id' + index" type="hidden"
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input @input="calculate()" type="text" readonly="readonly"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input @input="calculate()" type="text" readonly="readonly"
                                                    id="cantidad_total" v-model="total_quantity" class="form-control" />
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input @input="calculate()" type="text" readonly
                                                    id="subtotal_general_si" name="subtotal_general_si" value="0.00"
                                            ...
                                            <div class="col-md-12" v-show="show">
                                                ...
                                                <input @input="calculate()" type="text" readonly="readonly"
                                                    id="remaining" class="form-control" v-model="remaining" />
