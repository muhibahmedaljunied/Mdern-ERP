                            ...
                            {{ product.text }}
                                            ...
                                            <div class="custom-search">
                                                ...
                                                <input style="background-color: beige;"
                                                    :id="'Supply_product_tree' + index" type="text" readonly
                                                    class="custom-search-input">
                                                <input :id="'Supply_product_tree_id' + index" type="hidden" readonly
                                                    class="custom-search-input">
                                      ...
                                      <select v-model="store[index]" name="type" id="type" class="form-control"
                                          ...
                                          <option v-for="store in stores" v-bind:value="store.id">
                                            ...
                                            <div class="custom-search">
                                                ...
                                                <input style="background-color: beige;" :id="'Supply_store_tree' + index"
                                                    type="text" readonly class="custom-search-input">
                                                <input :id="'Supply_store_tree_id' + index" type="hidden" readonly
                                                    class="custom-search-input">
