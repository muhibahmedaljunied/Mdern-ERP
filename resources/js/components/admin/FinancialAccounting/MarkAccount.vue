                                                                ...
                                                                >
                                                                    <td>
                                                                        ...
                                                                        >
                                                                            ...
                                                                            <option
                                                                                v-for="types in type_groups"
                                                                                v-bind:value="
                                                                                    [types.group_type_id,types.group_type_code]
                                                                                "
                                                                            >
                                                                                {{
                                                                                    types.type_name
...
export default {
    ...
    methods: {
        ...
        onchange(index) {
            this.axios
                .post(`/get_group/${this.type_group[index][0]}`,{
                ...
                .then(({ data }) => {
                    ...
                    for (var i = 0; i < arrayLength; i++) {
                        html =
                            html +
                            `<option  value= ${data.groups[i].group_id} >${data.groups[i].group_name}  </option>`;
                    }
        ...
        list() {
            this.axios.post(`/group_marks`).then(({ data }) => {
