            ...
            <div class="col-xl-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div v-for="(accounts, index) in list_data" :key="index" class="row" v-if="accounts.type == 'purchase'">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="custom-search" v-if="accounts.account_id">
                                    ...
                                    <input style="background-color: beige;" :id="'Purchase_' + accounts.code + '_tree'" type="text" readonly class="custom-search-input" :value="accounts.account_id + accounts.account.first_name">
    
                                    <input style="background-color: beige;" :id="'Purchase_' + accounts.code + '_tree_id'" type="hidden" readonly class="custom-search-input" :value="accounts.account_id">
    
                                    <input style="background-color: beige;" :id="'Purchase_' + accounts.code + '_tree_hraccount_id'" type="hidden" readonly class="custom-search-input" :value="accounts.id">
    
                                    <button class="custom-search-botton" type="button" data-toggle="modal" :data-target="'#exampleModal' + accounts.code"> <i
                                ...
                                <div class="custom-search" v-else>
                                    ...
                                    <input style="background-color: beige;" :id="'Purchase_' + accounts.code + '_tree'" type="text" readonly class="custom-search-input">
    
                                    <input style="background-color: beige;" :id="'Purchase_' + accounts.code + '_tree_id'" type="hidden" readonly class="custom-search-input">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="custom-search" v-if="accounts.account_second_id">
                                    ...
                                    <input style="background-color: beige;" :id="'Purchase_' + accounts.code + accounts.type + '_tree'" type="text" readonly class="custom-search-input" :value="accounts.account_second_id + accounts.account_second.second_name">
    
                                    <input style="background-color: beige;" :id="'Purchase_' + accounts.code + accounts.type + '_tree_id'" type="hidden" readonly class="custom-search-input" :value="accounts.account_second_id">
    
                                    <input style="background-color: beige;" :id="'Purchase_' + accounts.code + accounts.type + '_tree_hraccount_id'" type="hidden" readonly class="custom-search-input" :value="accounts.id">
    
                                    <button class="custom-search-botton" type="button" data-toggle="modal" :data-target="'#exampleModal' + accounts.code + accounts.type">
                                ...
                                <div class="custom-search" v-else>
                                    ...
                                    <input style="background-color: beige;" :id="'Purchase_' + accounts.code + accounts.type + '_tree'" type="text" readonly class="custom-search-input">
    
                                    <input style="background-color: beige;" :id="'Purchase_' + accounts.code + accounts.type + '_tree_id'" type="hidden" readonly class="custom-search-input">
                            ...
                            <div v-for="(accounts, index) in list_data" :key="index" class="modal fade" :id="'exampleModal' + accounts.code" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="modal fade" :id="'exampleModal' + accounts.code + accounts.type" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
