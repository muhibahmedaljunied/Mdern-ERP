    ...
    <div class="card-body" id="printme">
      <div class="table-responsive">
        <table class="table table-bordered text-center">
          ...
          <tbody v-if="nationalities && nationalities.data.length > 0">
            <tr v-for="(nationality, index) in nationalities.data" :key="index">
              <td>{{ index + 1 }}</td>
              ...
              <td>
                ...
                <button type="button" @click="delete_nationality(nationality.id)"
