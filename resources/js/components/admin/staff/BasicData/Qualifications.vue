    ...
    <div class="col-xl-12">
      <div class="card">
        <div class="card-header">
          ...
          <span class="h2"> المؤهلات العلميه</span>
        ...
        <div class="card-body" id="printme">
            ...
            <table class="table table-bordered text-center">
              <thead>
                <tr>
                  ...
                  <th class="wd-15p border-bottom-0">المؤهل</th>


                  <th class="wd-15p border-bottom-0">العمليات</th>
                </tr>
              </thead>
              <tbody v-if="qualifications && qualifications.data.length > 0">
                <tr v-for="(qualification, index) in qualifications.data" :key="index">
                  <td>{{ index + 1 }}</td>
                  ...
                  <td>
                    ...
                    <button type="button" @click="delete_qualification(qualification.id)"
          ...
          <pagination align="center" :data="qualifications" @pagination-change-page="list"></pagination>

        </div>


        <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
          aria-hidden="true" style="display: none" id="addq">
          <div class="modal-dialog modal-lg" style="width: 100%">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <div class="col-md-8">
                  <h4 class="modal-title" id="myLargeModalLabel">المؤهلات العلميه</h4>
                </div>
                <div class="col-md-4">
                  <div class="col-sm-12">
