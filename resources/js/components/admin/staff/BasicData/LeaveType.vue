      ...
      <div class="col-xl-12">
        <div class="card">
          <div class="card-header">
            ...
            <span class="h2">نوع الانصراف</span>
          ...
          <div class="card-body" id="printme">
            <div class="table-responsive">
              <table class="table table-bordered text-center">
                ...
                <tbody v-if="leave_types && leave_types.length > 0">
                  <tr v-for="(leave_type, index) in leave_types" :key="index">
                    ...
                    <td>
                      ...
                      <button type="button" @click="delete_leave_type(leave_type.id)"
            ...
            <pagination align="center" :data="leave_types" @pagination-change-page="list"></pagination>
          </div>
