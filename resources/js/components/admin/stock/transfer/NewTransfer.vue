...
temx.name }}</span>
                        ...
                        <td>
                          <div class="input_nombre">
                            <select v-on:change="calculate_total(index)" style="background-color: beige;"
                        ...
                        <td>
                          ...
                          <input style="background-color: beige;" v-on:input="calculate_total(index)"
                            v-model="qty[index]" type="number" class="form-control input_cantidad" />

                          <input style="background-color: beige;" v-model="unit_price[index]" type="hidden"
...
export default {
  ...
  methods: {
    ...
    check_data(i) {
      ...
      if ((this.qty[i] * this.unit[i][1]) > this.detail[i].quantity) {
