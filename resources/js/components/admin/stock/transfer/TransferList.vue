                    ...
                    <div class="col-xl-12">
                        ...
                        <i class="fa fa-eye"></i>
                                                        ...
                                                        <button class="btn btn-success" type="button"
                                                            @click="get_details(transfer.id)"> <i
                    ...
                    <div class="col-xl-12">
                        ...
                        {{ transfer_detail.product }}
                                                ...
                                                <td>
                                                    ...
                                                    <div>
                                                        <input type="hidden" v-model="transfer_detail.text"
                                                            class="form-control" />

                                                        <span>{{ transfer_detail.text }}</span>
                                                        <span style="color: blue;" v-if="transfer_detail.kk"
                                                            v-for="ss in transfer_detail.kk">
