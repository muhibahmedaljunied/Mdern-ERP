      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="page-title-box">
            <h4 class="page-title">تقرير مرتجع الوارد</h4>
          </div>
        </div>
      </div>
      <!-- end row -->
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-2">
                    ...
                    >
                      <option value="1">حسب المورد</option>
                  ...
                  <div class="col-md-2">
                    ...
                    <a
                      ...
                      @click="
                        Search(supplierselected, productselected, storeselected)
                      "
                      data-toggle="modal"
...
export default {
  ...
  mounted() {
    this.axios.post("/Reposupplyreturn").then((response) => {
  ...
  created() {
    this.axios.post("/data_for_supply_return").then((response) => {
      this.customer = response.data.supplier;
  ...
  methods: {
    ...
    Search() {
      this.axios
        .post(`/reposupplyreturn_by_supplier`, {
        ...
        .then((response) => {
            ...
            //  console.log(response.data);
          this.report.data = response.data.reposupplyreturn;
