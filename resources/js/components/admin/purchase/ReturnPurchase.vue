                                            ...
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="wd-5p border-bottom-0">الكميه المتوفره</th>
                                                        ...
                                                        <th class="wd-5p border-bottom-0">الكميه المسموح ارجاعها</th>
                                                        <th class="wd-5p border-bottom-0">سعر الشراء</th>
                                                        <!-- <th>التكلفه</th> -->
                                                        <th class="wd-10p border-bottom-0">الكميه المرتجعه الفعليه</th>
                                                        <th class="wd-5p border-bottom-0">قيمه المرتجع</th>
                                                ...
                                                <tbody v-if="detail && detail.length > 0">
                                                    <tr v-for="(purchase_details, index) in detail" :key="index">
                                                        ...
                                                        <input v-model="id = purchase_details.purchase_id" type="hidden"
                                                        ...
                                                        <td>
                                                            ...
                                                            <div>
                                                                <input type="hidden" v-model="purchase_details.text" id="desc"
                                                                    class="form-control" />

                                                                <span>{{ purchase_details.text }}</span>
                                                                <span style="color: blue;" v-if="purchase_details.kk"
...
temx.name }}</span>
                      ...
                      purchase_details.units[1].name
                                                        ...
                                                        <td>{{ purchase_details.store }} <input
                                                                id="select_account_PurchaseReturn" type="hidden"
...
temx.name }}</span>
                      ...
                      purchase_details.units[1].name
                                ...
                                v-model="unit_price[index]" type="number" class="form-" /> -->
                                                            <input style="background-color: beige;" type="hidden"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="number" @input="take_discount()" v-model="discount"
                                                    :min="0" :max="99" :step="1" oninput="validity.valid||(value='');"
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input @input="calculate()" type="text" v-model="To_pay"
                                                    class="form-control" />
                                            </div>
