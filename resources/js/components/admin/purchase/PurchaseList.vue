                  ...
                  <td>{{ purchase.qty_return }}</td> -->
                                                ...
                                                <td>
                                                    ...
                                                    <span class="badge bg-warning"
                                                        v-if="purchase.payment_status == 'pendding'">غير مدفوعه</span>
                                                    <span class="badge bg-success"
                                                        v-if="purchase.payment_status == 'paiding'">مدفوعه</span>
                                                    <span class="badge bg-info"
                                                        v-if="purchase.payment_status == 'partialy'">مدفوعه جزئيا</span>
                            ...
                            دفع
                                                            ...
                                                            <option v-if="purchase.payment_status != 'paiding'"
                                ...
                                <pagination align="center" :data="purchases" @pagination-change-page="list">
                                </pagination>
                            </div>
                        </div>
                    </div>
