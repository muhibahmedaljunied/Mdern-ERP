          ...
          <div class="card-body">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-2">
                    ...
                    <select style="background-color: beige;" v-model="supplier" class="form-control" required>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <pagination align="center" :data="return_purchases" @pagination-change-page="list"></pagination>
              </div>
            </div>
