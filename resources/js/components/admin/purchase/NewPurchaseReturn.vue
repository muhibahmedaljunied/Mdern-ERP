              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-2">
                    ...
                    <div> <input style="background-color: beige;" name="date" type="number" v-model="purchase_id"
                        class="form-control" @input="get_purchase" /></div>
                  ...
                  <div class="col-md-4">
                    ...
                    <input v-if='purchase' name="date" type="number" v-model="purchase[0].grand_total"
                      class="form-control" />
...
temx.name }}</span>
                            ...
                            <td>{{ purchase_details.store }}
                              <input id="select_account_PurchaseReturn" type="hidden"
