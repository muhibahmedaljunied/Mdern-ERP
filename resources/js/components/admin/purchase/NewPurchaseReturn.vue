                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-2">
                                                ...
                                                <div> <input style="background-color: beige;" name="date" type="number"
                                                        v-model="purchase_id" class="form-control"
                                                        @input="get_purchase" /></div>

                                            </div>
                                            <div class="col-md-2">
                                                <label for="pagoPrevio">المورد</label>

                                                <input v-if='purchase' name="date" type="text"
                                                    v-model="purchase[0].name" class="form-control" />
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input v-if='purchase' name="date" type="number"
                                                    v-model="purchase[0].grand_total" class="form-control" />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <select class="form-control" style="background-color: beige;"
                                                    name="forma_pago" id="forma_pago" v-model="Way_to_pay_selected"
                      ...
                      <option v-bind:value="3">بنك</option>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="custom-search">
                                                    ...
                                                    <input :id="'PurchaseReturn_account_tree'" type="text"
                                                        class="custom-search-input">
                                                    <input :id="'PurchaseReturn_account_tree_id'" type="hidden"
                                                        class="custom-search-input">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select class="form-control" style="background-color: beige;"
                                                    name="forma_pago" id="select_account_PurchaseReturn_group">
                                            ...
                                            <!-- <div class="col-md-4">
                                                ...
                                                <input v-model="check_state_all" @change="check_all_return()"
                                                    ...
                                                    <table class="table">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <!-- <th> الباركود</th> -->
                                                                <th class="wd-10p border-bottom-0">كميه الشراء</th>
                                                                <th class="wd-10p border-bottom-0">الكميه المتوفره</th>
                                                                ...
                                                                <th class="wd-10p border-bottom-0">الكميه المسموح ارجاعها</th>
                                                                <th class="wd-10p border-bottom-0">سعر الشراء</th>
                                                                <th class="wd-10p border-bottom-0">الكميه المرتجعه الفعليه</th>
                                                                <th class="wd-10p border-bottom-0">قيمه المرتجع</th>
                                                                <th class="wd-10p border-bottom-0">ملاحظه</th>

                                                            </tr>
                                                        </thead>
                                                        <tbody v-if="detail && detail.length > 0">
                                                            <tr v-for="(purchase_details, index) in detail"
                                                                :key="index">

                                                                <input v-model="id = purchase_details.purchase_id"
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div>
                                                                        <input type="hidden"
                                                                            v-model="purchase_details.text" id="desc"
                                                                            class="form-control" />

                                                                        <span>{{ purchase_details.text }}</span>
                                                                        <span style="color: blue;"
                                                                            v-if="purchase_details.kk"
                                                                            v-for="ss in purchase_details.kk">
                                ...
                                <ejs-barcodegenerator ref="barcodeControl" width="180px" height="80px" type="Codabar"
                                  :value="purchase_details.product_code" mode="SVG"></ejs-barcodegenerator>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div
                                                                        v-for="temx in purchase_details.qty_after_convert['qty']">
...
temx.name }}</span>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div
                                                                        v-for="temx in purchase_details.qty_after_convert['quantity']">
...
temx.name }}</span>
                                                                ...
                                                                <td>{{ purchase_details.store }}
                                                                    <input id="select_account_PurchaseReturn"
                                                                        type="hidden"
                                                                        v-model="purchase_details.store_account">
                                                                </td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div
                                                                        v-for="temx in purchase_details.qty_after_convert['qty_remain']">
...
temx.name }}</span>
                                                                ...
                                                                <td>
                                                                    <input :input="calculate()" v-model="total[index]"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="number" @input="take_discount" v-model="discount"
                                                            :min="0" :max="99" :step="1"
                            ...
                            <i class="fa fa-credit-card"></i></a>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <label for="subTotal">الاجمالي (بدون ضريبه)
                                                            <small></small></label>
                                                    ...
                                                    <div class="col-md-12">
                                                        <label for="subTotal">الاجمالي (مع الضريبه)
                                                            <small></small></label>
                                                    ...
                                                    <div class="col-md-12" v-show="show">
                                                        ...
                                                        <input @input="calculate()" class="form-control" type="text"
                                                            id="paid" v-on:input="credit" v-model="paid"
                                                            style="color: red" />
...
export default {
    ...
    methods: {
        ...
        // check_one_return_purchase(purchase_details, index) {
        ...
        //       this.check_one_return_purchase(element, index);
        //     });
        ...
        // },
        // check_qty(index, qty, unit, avilable_qty, qty_remain) {
        ...
        check_data(i) {
            ...
            // console.log(this.qty[i], this.unit[i][1], this.detail[i].quantity, this.detail[i].qty);
        ...
        get_purchase() {
            ...
            let uri = `/purchase_details_in_return/${this.purchase_id}`;
